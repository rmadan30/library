...
<body>
    ...
    <section style="height: 700px; width: 1556px">
        <div class="log_img">
            <br>
            <div class="box1">
                ...
                <br>
                    ...
                    <p style="font-size:15px; color: white; padding-left: 45px;">
                        <br><br>
                        <a style="font-size:15px; color: yellow; text-decoration: none;" href="update_password.php">Forgot Password?</a>&nbsp; &nbsp;
                        New to this Website? <a style="font-size:15px; color: yellow; text-decoration: none;" href="registration.php">Sign-Up</a>
                    </p>
                </form>
            </div>
        </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            if($_POST['user']=='admin'){
                $count=0;
                $result=mysqli_query($db,"SELECT * FROM `admin` WHERE username='$_POST[username]' && password='$_POST[password]' && `status`='yes';");
    ...
    <div class="alert alert-danger" style="width: 400px; margin-left: 550px; text-align:center; margin-top:-100px; background-color:#de1313; color:white;">
    ...
    ?>
        <script text="text/javascript">
            alert("Verify your email via otp before logging in");
