...
<body>
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            $sql1= "UPDATE `admin` SET  `first`='$first', `last`='$last', `contact`='$contact', `email`='$email', `username`='$username', `password`='$password', `pic`='$pic' where username='".$_SESSION['login_user']."';";
